...
private struct AnimatedXmark: View {
    ...
    struct ActivityIndicator: NSViewRepresentable {
        ...
        func updateNSView(
            _: NSProgressIndicator, context _: NSViewRepresentableContext<ActivityIndicator>
        ) {}
    }
#else
    @available(iOS 13, *)
    struct ActivityIndicator: UIViewRepresentable {
        func makeUIView(context _: UIViewRepresentableContext<ActivityIndicator>)
        ...
        func updateUIView(
            _: UIActivityIndicatorView, context _: UIViewRepresentableContext<ActivityIndicator>
        ) {}
    }
#endif
...
extension View {
    ...
    /// - Returns: `AlertToast`
    public func toast(
        isPresenting: Binding<Bool>, duration: Double = 2, tapToDismiss: Bool = true,
